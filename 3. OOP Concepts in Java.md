...
* Copy Constructor (copy values from another object)
* Private Constructor
* Static Constructor ❌
 No static constructors exist
 Alternative: Use static block
...
```
* Constructor Overloading (Multiple constructors in same class with different parameters)
